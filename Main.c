...
/* NOTE: Dictionary name, is taken at; dictionary[0][0], everything needs to be moved up by one to accomidate. Including the dictionary initalization. */
...
int main()
{
    initDict("Kyle", 3, "a,b,c,d");
    initDict("Fred", 3, "1,2,3,4");
    initDict("Fappy", 5, "how,is,the,weather,in,Florida,today");
    printf("%s\n", previousElem("Fappy", 2));
    printf("%s\n", nextElem("Fred", 2));
    printf("%s\n", nextElem("Kyle", 2));
    return 0;
}
